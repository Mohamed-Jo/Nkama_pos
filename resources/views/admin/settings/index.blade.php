...
@section('page-title', 'ConfiguraÁ„o de Empresa')
...
@section('content')
    ...
    <div class="settings-wrap">
        ...
        <div class="settings-nav">
            <a class="active" href="{{ route('admin.settings.index') }}">Dados, IVA e impress„o</a>
        ...
        <form method="POST" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data" class="settings-panel">
            ...
            <div class="settings-section">
                <div class="settings-title">IVA padr√£o</div>
                ...
                <div class="settings-grid">
                    ...
                    <div class="settings-field">
                        <label for="tax-value">Valor padr√£o do IVA (%)</label>
