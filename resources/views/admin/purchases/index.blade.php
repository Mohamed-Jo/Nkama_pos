...
@section('content')
    ...
    <div class="purchase-wrap">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-box"><div class="stat-label">Por receber</div><div class="stat-value">{{ $totals['draft'] }}</div></div>
                    ...
                    <tbody>
                        @foreach($purchases as $purchase)
                            <tr>
                                ...
                                <td>
                                    <span class="badge {{ $purchase->status === 'received' ? 'badge-received' : 'badge-draft' }}">
                                        {{ $purchase->status === 'received' ? 'Recebida' : 'Por receber' }}
                                    </span>
                                </td>
